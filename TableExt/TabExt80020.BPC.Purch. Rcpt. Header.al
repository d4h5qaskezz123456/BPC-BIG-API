tableextension 80020 "Purch. Rcpt. Header" extends "Purch. Rcpt. Header"
{
    fields
    {
        ...
        field(80119; "BPC.Post at FO Status"; Boolean)
        {
            ...
            //Kim 2025-05 ++
            CalcFormula = Min("BPC.Interface Document Status"."BPC.Posted At FO" WHERE("BPC.Document No." = FIELD("No.")));
            //Kim 2025-05 --
